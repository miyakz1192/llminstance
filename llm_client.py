...
class SwallowClient:
    ...
    def ask(self, instruction_example, input_example):
        ...
        start_time = datetime.now()
        print(f"DEBUG: swallow in ask {instruction_example}+{input_example}")
        end_time = datetime.now()
        print(res)
        print(f"elapsed time: {end_time - start_time}")
    ...
    def create_prompt(self, instruction, input_=None):
        PROMPT_DICT = {
            "prompt_input": (
